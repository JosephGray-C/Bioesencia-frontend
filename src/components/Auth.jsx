...
function Auth() {
  ...
  const handleLogin = async (e) => {
    ...
    loginMutation.mutate(
      ...
      {
        onSuccess: async () => {
          // Refresca usuario global tras login
          ...
          <div className="form-content">
              ...
              <form id="loginForm" onSubmit={handleLogin}>
                <div className="input-boxes">
                  ...
                  <div className="button input-box">
                    <input type="submit" value={loginMutation.isLoading ? "Cargando..." : "Iniciar sesión"} />
                  </div>
            ...
            <div className="signup-form">
              ...
              <div
                className="code-form"
                id="codeForm"
                style={{ display: showCodeForm ? "block" : "none" }}
              >
