            ...
            <div className="container">
                ...
                <div className="cover">
                    <div className="front">
                        ...
                        <div className="text">
                            <span className="text-1">
                                Cada nuevo encuentro <br /> es una oportunidad
                                de sanar
                            </span>
                    ...
                    <div className="back">
                        ...
                        <div className="text">
                            <span className="text-1">
                                El equilibrio interior <br /> comienza con un
                                paso
                            </span>
                            <span className="text-2">
                                Comienza con Biosencia
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="form-content">
                        ...
                        <div className="signup-form">
                            ...
                            <form
                                ...
                                style={{
                                    display: showCodeForm ? "none" : "block",
                                }}
                            >
                                <div className="input-boxes">
                                    <div className="input-box">
                            ...
                            <div
                                ...
                                id="codeForm"
                                style={{
                                    display: showCodeForm ? "block" : "none",
                                }}
                            >
                                    ...
                                    <div className="input-boxes">
                                        ...
                                        <div className="button input-box">
                                            <input
                                                type="submit"
                                                value={
                                                    verificarRegistroMutation.isLoading
                                                        ? "Verificando..."
                                                        : "Verificar Código"
                                                }
                                                disabled={
